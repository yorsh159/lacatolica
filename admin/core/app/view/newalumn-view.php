<div class="row">
   ...
   <form class="form-horizontal" method="post" id="addcategory" action="index.php?action=alumns&opt=add" role="form">
  ...
  <div class="form-group">
    ...
    <option value="<?php echo $parent->id; ?>"><?php echo $parent->name." ".$parent->lastname; ?></option>
    <?php endforeach; ?>
    </select>
    </div>
