...
///////////////
$block = BlockData::getById($_GET["bid"]);
...
$blocks = BlockData::getAllByBlockId($block->id);
...
$section1->addText("REPORTE DE CALIFICACIONES ".$block->name);
...
$filename = "calificationsbyblock-".time().".docx";
