...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Xoolar Max | Alumn Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>X</b>M</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>XOOLAR</b>MAX</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class=""><?php if(isset($_SESSION["alumn_id"]) ){ echo PersonData::getById($_SESSION["alumn_id"])->name; }?> <span class="caret"></span>
                  </span>
                </a>
